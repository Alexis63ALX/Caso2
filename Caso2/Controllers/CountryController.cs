...
namespace Caso2.Controllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        public CountryController(Parcial20230220100619Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Country>> PostCountry(Country country)
        {
          if (_context.Country == null)
          {
              return Problem("Entity set 'Parcial20230220100619Context.Country'  is null.");
          }
        ...
        {
            return (_context.Country?.Any(e => e.IdCountry == id)).GetValueOrDefault();
        }
    }
}
